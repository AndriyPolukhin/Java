...
public class MadLibs {
  ...
  public void printInstructions() {
    System.out.println("Welcome to the MadLibs game. If you type in "
                      +"words, we'll give you a story. Start by typin in a name");
  }

  // Make the method to get the data from the user
  ...
  public void enterAdjective2() {
    System.out.println("I need one more adjective or an alpaca...!");
  ...
  public void putTogetherTheStory() {
    ...
    if (num == 0) {
      story = "Anastasia and her best friend " + getName()+" went to Disney world today!"
      ...
      + getAdjective2() + " fireworks shouting from the " + getNoun3() + ".";
    } else {
      ...
      + "The zoo was " + getAdjective1()+ " at night by they didn't care"
      +"...until "+ getRandomNums() + " "+ getAdjective2() +" apes yelled in their faces, making "
      + "Amanda and "+getName()+ " sprinit all the way back home.";
    }
    setStory(story);
  }
